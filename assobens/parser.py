...
ALIASES: dict[str, list[str]] = {
    ...
    "TIPO TERRENO": ["TIPO TERRENO", "TERRENO", "TIPO_TERRENO", "TIPOTERRENO"],
    # Colunas do export do Power BI mapeadas mas não publicadas (ficam no arquivo bruto).
    "CODMODELO": ["CODMODELO", "COD MODELO", "CODIGO MODELO", "CÓDIGO MODELO"],
    "CAPACIDADE PASSAGEIROS": ["CAPACIDADE PASSAGEIROS", "CAPACIDADE_PASSAGEIROS", "CAPACIDADE DE PASSAGEIROS"],
    "CPFCNPJPROPRIETARIO": ["CPFCNPJPROPRIETARIO", "CPF/CNPJ PROPRIETARIO", "CPF/CNPJ PROPRIETÁRIO", "CPF OU CNPJ DO PROPRIETÁRIO",
                            "CPF OU CNPJ DO PROPRIETARIO", "C_CPFCNPJPROPRIETARIO", "CPF/CNPJ", "CPFCNPJ", "CPF CNPJ", "CPF CNPJ PROPRIETARIO",
                            "CPF CNPJ PROPRIETÁRIO", "CNPJ PROPRIETARIO", "CNPJ PROPRIETÁRIO",
